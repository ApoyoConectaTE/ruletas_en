...
const cuatro = {
  nombre: "Industry Hacking",
  probabilidad: 11.112,
};
const cinco = {
  nombre: "Cities of the Future",
  probabilidad: 11.112,
};
const seis = {
  nombre: "Ecosystems",
...
function ajustarRuleta() {
  ...
  conceptos.forEach((concepto, i) => {
    ...
    ganadorTextoElement.textContent = `Click "Spin" to start!`;
  });
}
